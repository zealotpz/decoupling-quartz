...
public class HttpUtil {
    ...
    private static final RequestConfig requestConfig = RequestConfig.custom().setSocketTimeout(60000).setConnectTimeout(60000).setConnectionRequestTimeout(60000).build();
    ...
    public static String sendGet(String url) {
        ...
        try {
            ...
            LOGGER.error(String.format("exception error msg : %s", e.getMessage()), e);
            return null;
        }
    ...
    public static String sendPost(String url, Map<String, String> params) {
        ...
        try {
            ...
            LOGGER.error(String.format("UnsupportedEncoding error msg : %s", e.getMessage()), e);
            return null;
        }
...
//			System.out.println(EntityUtils.toString(entity));
    ...
    public static Map<String, String> getFormParameters(ServletRequest request) {
        ...
        try {
            ...
            for (Map.Entry<String, String[]> entry : parameterMap.entrySet()) {
                ...
                parametersMap.put(entry.getKey(),
    ...
    private static SSLConnectionSocketFactory createSSLConnSocketFactory() {
        ...
        try {
            ...
            LOGGER.error(String.format("GeneralSecurity error msg : %s", e.getMessage()), e);
        }
        return sslsf;
    }
            ...
            for (Map.Entry<String, String> query : querys.entrySet()) {
                ...
                if (!StringUtils.isEmpty(query.getKey())) {
                    ...
                    if (!StringUtils.isEmpty(query.getValue())) {
                        sbQuery.append("=");
                        sbQuery.append(URLEncoder.encode(query.getValue(), UTF_8));
                    }
                }
            }
            if (0 < sbQuery.length()) {
